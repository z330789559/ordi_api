...
public class AppItemPageReqVO extends PageParam {
    ...
    @Schema(description = "排序字段", example = "price") // 参见 AppItemPageReqVO.SORT_FIELD_XXX 常量
    private String sortField;

    @Schema(description = "排序方式", example = "true")
    private Boolean sortAsc;

    @Schema(description = "推荐类型", example = "hot") // 参见 AppItemPageReqVO.RECOMMEND_TYPE_XXX 常量
    private String recommendType;

    @Schema(description = "状态", example = "1") // 参见 AppItemPageReqVO.RECOMMEND_TYPE_XXX 常量
