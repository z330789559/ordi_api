package cn.iocoder.yudao.module.system.enums.web3;
...
@Getter
@AllArgsConstructor
public enum Web3TypeEnum implements IntArrayValuable {
    ...
    public static final int[] ARRAYS = Arrays.stream(values()).mapToInt(Web3TypeEnum::getType).toArray();
    ...
    public static Web3TypeEnum valueOfType(Integer type) {
