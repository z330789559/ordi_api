...
public interface PayWalletService {
    ...
    PayWalletDO getWalletByUser(Long userId);

    List<PayWalletDO> getWalletByUserIds(Collection<Long> ids, Integer type);
     ...
     * @param price      金额
     */
    PayWalletTransactionDO orderPay(Long userId, Integer userType, String outTradeNo, BigDecimal price);
    ...
    PayWalletTransactionDO unfrozenWalletBalance(Long walletId,Long bizId,
                                               PayWalletBizTypeEnum bizType, BigDecimal price);
