...
public interface ErrorCodeConstants {
    ...
    ErrorCode USER_BIND_NOT_REPEAT = new ErrorCode(1_004_001_001, "不能重复绑定邀请人");
    ErrorCode USER_BIND_NOT_EXISTS = new ErrorCode(1_004_001_001, "邀请人不存在");

    ErrorCode USER_BIND_NOT_SELF = new ErrorCode(1_004_001_001, "邀请人不能是自己");

    ErrorCode USER_BIND_NOT_FATHER = new ErrorCode(1_004_001_001, "邀请人不能互相绑定");
    ErrorCode USER_BIND_FATHER_NOT_BIND = new ErrorCode(1_004_001_001, "邀请人未绑定");
    ...
    //========== 用户分组 1-004-013-000 ==========
    ErrorCode USER_BIND_BRC_ADDRESS_NOT_REPEAT = new ErrorCode(1_004_013_000, "不能重复绑定地址");
}
