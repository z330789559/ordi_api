...
import cn.iocoder.yudao.module.admin.dal.mysql.oauth2.AdminOAuth2ApproveMapper;
...
@Service
@Validated
public class OAuth2AdminApproveServiceImpl implements OAuth2ApproveService {
    ...
    @Resource
    private AdminOAuth2ApproveMapper oauth2ApproveMapper;
    ...
    public boolean checkForPreApproval(Long userId, Integer userType, String clientId, Collection<String> requestedScopes) {
        ...
        List<AdminOAuth2ApproveDO> approveDOs = getApproveList(userId, userType, clientId);
        Set<String> scopes = convertSet(approveDOs, AdminOAuth2ApproveDO::getScope,
                AdminOAuth2ApproveDO::getApproved); // 只保留未过期的 + 同意的
    ...
    @Override
    public List<AdminOAuth2ApproveDO> getApproveList(Long userId, Integer userType, String clientId) {
        List<AdminOAuth2ApproveDO> approveDOs = oauth2ApproveMapper.selectListByUserIdAndUserTypeAndClientId(
    ...
    void saveApprove(Long userId, Integer userType, String clientId,
        ...
        // 先更新
        AdminOAuth2ApproveDO approveDO = new AdminOAuth2ApproveDO().setUserId(userId).setUserType(userType)
