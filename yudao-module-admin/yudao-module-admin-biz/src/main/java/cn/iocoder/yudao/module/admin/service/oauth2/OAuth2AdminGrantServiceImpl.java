...
import cn.iocoder.yudao.module.admin.enums.ErrorCodeConstants;
 ...
 */
@Service
public class OAuth2AdminGrantServiceImpl implements OAuth2GrantService {
    ...
    @Override
    public AdminOAuth2AccessTokenDO grantImplicit(Long userId, Integer userType,
    ...
    @Override
    public AdminOAuth2AccessTokenDO grantAuthorizationCodeForAccessToken(String clientId, String code,
                                                                    String redirectUri, String state) {
        AdminOAuth2CodeDO codeDO = oauth2CodeService.consumeAuthorizationCode(code);
    ...
    @Override
    public AdminOAuth2AccessTokenDO grantPassword(String username, String password, String clientId, List<String> scopes) {
        // 使用账号 + 密码进行登录
    ...
    @Override
    public AdminOAuth2AccessTokenDO grantRefreshToken(String refreshToken, String clientId) {
        return oauth2TokenService.refreshAccessToken(refreshToken, clientId);
    }

    @Override
    public AdminOAuth2AccessTokenDO grantClientCredentials(String clientId, List<String> scopes) {
    ...
    public boolean revokeToken(String clientId, String accessToken) {
        ...
        AdminOAuth2AccessTokenDO accessTokenDO = oauth2TokenService.getAccessToken(accessToken);
