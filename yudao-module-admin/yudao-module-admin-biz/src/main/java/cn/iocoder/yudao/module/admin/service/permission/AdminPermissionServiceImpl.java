...
import cn.iocoder.yudao.module.admin.dal.dataobject.permission.RoleMenuDO;
import cn.iocoder.yudao.module.admin.dal.mysql.permission.RoleMenuMapper;
import cn.iocoder.yudao.module.admin.dal.mysql.permission.UserRoleMapper;
import cn.iocoder.yudao.module.admin.dal.redis.RedisKeyConstants;
import cn.iocoder.yudao.module.admin.enums.permission.DataScopeEnum;
...
public class AdminPermissionServiceImpl implements PermissionService {
    ...
    public void assignUserRole(Long userId, Set<Long> roleIds) {
        ...
        if (!CollectionUtil.isEmpty(createRoleIds)) {
            userRoleMapper.insertBatch(CollectionUtils.convertList(createRoleIds, roleId -> {
                AdminUserRoleDO entity = new AdminUserRoleDO();
    ...
    public Set<Long> getUserRoleIdListByUserId(Long userId) {
        return convertSet(userRoleMapper.selectListByUserId(userId), AdminUserRoleDO::getRoleId);
    }
    ...
    public Set<Long> getUserRoleIdListByRoleId(Collection<Long> roleIds) {
        return convertSet(userRoleMapper.selectListByRoleIds(roleIds), AdminUserRoleDO::getUserId);
    }
     ...
     * @return 自己
     */
    private AdminPermissionServiceImpl getSelf() {
