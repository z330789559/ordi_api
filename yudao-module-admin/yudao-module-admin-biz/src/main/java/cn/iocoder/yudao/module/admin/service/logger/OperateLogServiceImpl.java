...
import cn.iocoder.yudao.module.admin.api.logger.dto.OperateLogCreateReqDTO;
import cn.iocoder.yudao.module.admin.api.logger.dto.OperateLogV2CreateReqDTO;
import cn.iocoder.yudao.module.admin.api.logger.dto.OperateLogV2PageReqDTO;
import cn.iocoder.yudao.module.admin.controller.admin.logger.vo.operatelog.OperateLogPageReqVO;
import cn.iocoder.yudao.module.admin.dal.dataobject.logger.OperateLogDO;
import cn.iocoder.yudao.module.admin.dal.dataobject.logger.OperateLogV2DO;
import cn.iocoder.yudao.module.admin.dal.dataobject.user.AdminUserDO;
import cn.iocoder.yudao.module.admin.dal.mysql.logger.OperateLogMapper;
import cn.iocoder.yudao.module.admin.dal.mysql.logger.OperateLogV2Mapper;
...
import static cn.iocoder.yudao.module.admin.dal.dataobject.logger.OperateLogDO.JAVA_METHOD_ARGS_MAX_LENGTH;
import static cn.iocoder.yudao.module.admin.dal.dataobject.logger.OperateLogDO.RESULT_MAX_LENGTH;
